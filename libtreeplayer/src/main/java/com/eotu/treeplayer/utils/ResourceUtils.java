package com.eotu.treeplayer.utils;
    ...
    public static int getResourceIdByName(Context context, String className, String name) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Log.d("", "ClassNotFoundException: class=" + className + " fieldname=" + name);
            } catch (IllegalArgumentException var8) {
                Log.d("", "IllegalArgumentException: class=" + className + " fieldname=" + name);
            } catch (SecurityException var9) {
                Log.d("", "SecurityException: class=" + className + " fieldname=" + name);
            } catch (IllegalAccessException var101) {
                Log.d("", "IllegalAccessException: class=" + className + " fieldname=" + name);
            } catch (NoSuchFieldException var11) {
                Log.d("", "NoSuchFieldException: class=" + className + " fieldname=" + name);
            }
